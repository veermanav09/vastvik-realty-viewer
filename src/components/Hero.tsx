  ...
  return <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden pt-20 px-4 md:px-8" style={{
    opacity
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 text-center">
        ...
        <div className={`absolute bottom-4 left-1/2 transform -translate-x-1/2 text-white/80 transition-all duration-1000 delay-700 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
