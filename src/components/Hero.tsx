...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div 
        className="absolute inset-8 md:inset-12 rounded-[32px] overflow-hidden transition-all duration-700"
        style={{ 
      ...
      >
        ...
        <div className="absolute top-1/2 left-1/3 w-48 h-48 bg-white/3 rounded-full blur-2xl animate-float-slow" style={{ animationDelay: '-2s' }}></div>
        
        {/* Additional atmospheric elements */}
        <div className="absolute top-1/4 right-1/4 w-32 h-32 bg-primary/10 rounded-full blur-2xl animate-float-slower" style={{ animationDelay: '-3s' }}></div>
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 text-center">
        <div className="max-w-6xl mx-auto depth-3d">
          ...
          <div 
            className={`mb-12 depth-3d-item transition-all duration-1000 ${
          ...
          <div 
            className={`depth-3d-item transition-all duration-1000 delay-200 ${
        ...
        >
          <div className="flex flex-col items-center space-y-2 group cursor-pointer">
            ...
            <div className="w-6 h-10 rounded-full border-2 border-white/50 flex items-start justify-center p-1.5 group-hover:border-white/80 transition-colors">
